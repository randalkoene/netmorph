...
$(OBJ_PATH)/global.o: global.cc global.hh file.hh Fig_Object.hh Command_Line_Parameters.hh mtprng.hh BigString.hh Include/Embeddable.h
...
$(OBJ_PATH)/common_entry.o: common_entry.cc global.hh nibr.hh
	$(CCPP) $(CPPFLAGS) $(COLORS) -DVECTOR3D -DFIG2DEV=\"$(FIG2DEV)\" -c common_entry.cc -o $(OBJ_PATH)/common_entry.o
	$(CCPP) $(CPPFLAGS) $(COLORS) -DVECTOR2D -DFIG2DEV=\"$(FIG2DEV)\" -c common_entry.cc -o $(OBJ_PATH)/common_entry2D.o
