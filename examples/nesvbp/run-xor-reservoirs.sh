...
if [ -d ../../../Source ]; then
	cd ../../../Binaries
	./NetmorphCMake "include=../Source/examples/nesvbp/nesvbp-xor-reservoirs" "outattr_directory=../Source/examples/nesvbp/" $EXTRA $BLENDER
	cd ../Source/examples/nesvbp
else
	cd ../../bin
	./netmorph "include=../examples/nesvbp/nesvbp-xor-reservoirs" "outattr_directory=../examples/nesvbp/" $EXTRA $BLENDER
	cd ../examples/nesvbp
fi
